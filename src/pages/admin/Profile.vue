<template>
    <div class="min-h-screen p-4 lg:p-6 bg-neutral-50">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-neutral-900">Mi Perfil</h1>
            <p class="mt-1 text-neutral-500">Gestiona tu información personal y configuración</p>
        </div>
                ...
                >
                    ...
                    <div class="relative px-6 pb-6">
                        <div class="flex justify-center -mt-16">
                            <div class="relative">
                                <div
                                    ...
                                    class="w-32 h-32 overflow-hidden bg-white border-4 border-white rounded-full shadow-lg"
                                >
                                    <img
                                ...
                                <div
                                    v-else
                                    class="flex items-center justify-center w-32 h-32 text-4xl font-bold text-white bg-white border-4 border-white rounded-full shadow-lg"
                                    :style="{
                                        background: `linear-gradient(135deg, ${
                                            siteSettings?.color_primario || '#2563eb'
                                        }, ${darkenColor(
                                ...
                                <button
                                    ...
                                    class="absolute bottom-0 right-0 p-2 text-white rounded-full shadow-lg"
                                    :style="{
                        ...
                        <div class="mt-4 text-center">
                            ...
                            <p class="mt-1 text-sm text-neutral-500">{{ user?.email }}</p>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-6">
                            <div class="p-4 text-center rounded-lg bg-neutral-50">
                        ...
                        <div class="pt-4 mt-6 border-t border-neutral-200">
                            <div class="space-y-3">
                                <div class="flex items-center gap-3 text-sm">
                                    <Mail :size="16" class="text-neutral-400" />
                                ...
                                >
                                    <Phone :size="16" class="text-neutral-400" />
                    ...
                    <div v-else class="p-6">
                            ...
                            <form @submit.prevent="updateProfile" class="space-y-6">
                                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            class="w-full px-4 py-2 border rounded-lg border-neutral-300 focus:ring-2 focus:border-transparent"
                                            :style="{
                                                '--tw-ring-color':
                                                    siteSettings?.color_primario || '#2563eb',
                                            }"
                                ...
                                <div class="flex justify-end">
                                    <button
                                        type="submit"
                                        :disabled="saving"
                                        class="px-6 py-3 font-medium text-white transition-all rounded-lg shadow-md hover:shadow-lg disabled:opacity-50"
                                        :style="{
                                            backgroundColor:
                                                siteSettings?.color_primario || '#2563eb',
                                        }"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input
                                                ...
                                                type="email"
                                                required
                                                class="w-full py-2 pl-10 pr-4 border rounded-lg border-neutral-300 focus:ring-2 focus:border-transparent"
                                                :style="{
                                                    '--tw-ring-color':
                                                        siteSettings?.color_primario || '#2563eb',
                                                }"
                        ...
                        <div v-if="activeTab === 'security'">
                            <form @submit.prevent="updatePassword" class="space-y-6">
                                <div
                                    class="p-4 mb-6 border-l-4 border-blue-500 rounded-lg bg-blue-50"
                                >
                                    <div class="flex items-start gap-3">
                                        <Shield :size="20" class="mt-0.5 text-blue-600" />
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input
                                                ...
                                                class="w-full py-2 pl-10 pr-10 border rounded-lg border-neutral-300 focus:ring-2 focus:border-transparent"
                                                :style="{
                                                    '--tw-ring-color':
                                                        siteSettings?.color_primario || '#2563eb',
                                                }"
...
const loadUserData = async () => {
    ...
    try {
        ...
        // Por ahora uso el ID 7 como ejemplo
        const userId = 7; // TODO: Obtener del auth store
...
const updateProfile = async () => {
    ...
    try {
        ...
        await updateUser(user.value.id, formDataObj);
