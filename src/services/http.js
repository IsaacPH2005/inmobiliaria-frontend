...
/* https: export const urlBase = import.meta.env.VITE_API_URL || 'http://127.0.0.1:8000/api';
...
export const urlBaseAsset =
    import.meta.env.VITE_ASSET_URL || 'http://127.0.0.1:8000/apic'; */
//Para entorno de desarrollo produccion
// ===== CONFIGURACIÓN BASE DE AXIOS =====
// Configuración común para todas las instancias de axios
const baseConfig = {
    timeout: 30000, // 30 segundos de tiempo límite para todas las peticiones
    headers: {
